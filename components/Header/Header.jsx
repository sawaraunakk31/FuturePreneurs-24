...
const Logo = () => {
  ...
  return (
    <div className="flex flex-wrap flex-direction-row items-center justify-center space-x-[0.75rem] bg-blur opacity-80 min-h-screen">
      ...
      <div className="relative flex items-center text-black mb-[5rem]"> 
        ...
        <div className="absolute -top-[1rem] left-[11.25rem] bottom-[5rem] mt-[2.1875rem] text-[0.75rem] font-bold text-black z-1" 
        style={{ fontFamily: 'TrapBlack', fontWeight: '800' }}>
          <span>th</span>
        </div>

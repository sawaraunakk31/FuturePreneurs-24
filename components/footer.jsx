...
const Footer = () => {
  return (
    <footer className="bg-[#000000] overflow-hidden ">
    <div className="flex flex-col gap-10">
      <div className="flex flex-row text-white flex-grow ">
        <div className=" flex flex-col gap-5 pl-5 pr-5 w-[50vw]">
          <h1 className='pl-10 text-[5vw] text-[#F79D68] font-[700]  after:content-["We_Breed_Business"] after:text-[1vw] after:text-[#FFFFFF] flex flex-col gap-0 after:absolute after:t-0 after:pl-[0.4vw] after:mt-[11vh]'>
            E-CELL
          </h1>
          <div className="pl-10 ">
        ...
        <div className="flex flex-col justify-center items-center  pl-5 pr-5 w-[50vw]">
      ...
      <div className='w-screen h-[fit-content] flex justify-around items-center flex-wrap gap-5 mb-5'>
      <div className="w-[17vw] h-[fit-content]  flex flex-col">
        <div className='border rounded-xl border-b-0 pb-5 p-5'>
          <h1 className='text-[#FFFFFF] text-xl pl-5 items-center pt-2'>INSTAGRAM</h1>
        </div>
          <div className='flex flex-row gap-16 pl-5 border rounded-xl border-t-0 pt-5 pb-2'>
        ...
        <div className="w-[17vw] h-[fit-content]  flex flex-col">
          <div className='border rounded-xl border-b-0 pb-5 p-5 '>
            <h1 className='text-[#FFFFFF] text-xl pl-5 items-center pt-2 '>LINKEDIN</h1>
          </div>
          <div className='flex flex-row gap-16 pl-5 border rounded-xl border-t-0 pt-5 pb-2'>
        ...
        <div className="w-[17vw] h-[fit-content]  flex flex-col">
          <div className='border rounded-xl border-b-0 pb-5 p-5'>
            <h1 className='text-[#FFFFFF] text-xl pl-5 items-center pt-2 '>YOUTUBE</h1>
          </div>
          <div className='flex flex-row gap-16 pl-5 border-2 rounded-xl border-t-0 pt-5 pb-2' >
        ...
        <div className="w-[17vw] h-[fit-content]  flex flex-col ">
          <div className='border rounded-xl border-b-0 pb-5 p-5'>
            <h1 className='text-[#FFFFFF] text-xl pl-5 items-center pt-2'>X</h1>
          </div>
          <div className='flex flex-row gap-10 pl-5 border rounded-xl border-t-0 pt-5 pr-5 pb-2'>

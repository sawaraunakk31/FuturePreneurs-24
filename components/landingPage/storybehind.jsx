...
export default function Home() {
  return (
    ...
    <div className=" hidden md:block bg-white py-12 px-4">
      {/* Header Section */}
      <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-8 rounded-xl shadow-lg w-full max-w-4xl mx-auto border-2 border-purple-400">
        ...
        <p className="text-black font-almarai mt-10">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-6 rounded-xl max-h-fit border-2 border-purple-400 hidden md:block"> {/* Visible only on medium and large devices */}
          ...
          <div className="relative w-full h-auto bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 rounded">
            <img src={problemsolving.src} alt="" className="float-right h-32 w-32 m-2" />
            <p className="text-black font-almarai mt-12">
        ...
        <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-6 rounded-xl max-h-fit border-2 border-purple-400 hidden md:block"> {/* Visible only on medium and large devices */}
          ...
          <div className="relative w-full h-auto bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 rounded">
            <img src={skilltest.src} alt="" className="float-right h-32 w-32 m-2" />
            <p className="text-black font-almarai mt-12">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque congue massa justo, ut cursus leo fringilla tempus. Sed tempus bibendum...
            </p>
          </div>
        ...
        <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-6 rounded-xl max-h-fit border-2 border-purple-400 hidden md:block"> {/* Visible only on medium and large devices */}
          ...
          <div className="relative w-full h-auto bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 rounded">
            <img src={selfanalysis.src} alt="" className="float-right h-32 w-32 m-2" />
            <p className="text-black font-almarai mt-12">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque congue massa justo, ut cursus leo fringilla tempus. Sed tempus bibendum...
            </p>
          </div>
    ...
    <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-8 rounded-xl shadow-lg w-full max-w-4xl mx-auto mt-[4rem] border-2 border-purple-400">
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2">
          
            <div className="flex items-center w-[17rem] bg-white px-6 py-2 rounded-t-lg rounded-b-lg border-2 border-black mt-[-3.2rem]">
      ...
      <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-8 rounded-xl shadow-lg w-full max-w-4xl mx-auto mt-[4rem] border-2 border-purple-400">
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
          <div className="flex w-[10.2rem] bg-white border-b-2 border-b-purple-400 border-r-2 border-r-purple-400 border-l-2 border-l-purple-400 px-4 py-4 rounded-b-lg mt-[1.9rem]">
            <div className="flex items-center w-[9rem] bg-white px-4 py-2 rounded-t-lg rounded-b-lg mb-[-0.5rem] mr-[-0.5rem] ml-[-0.5rem] border-2 border-black mt-[-3.2rem]">
              <h1 className="text-xl font-extrabold font-outfit ">EXPLORE</h1>
             
            </div>
          </div>
        </div>
        <img src={selfanalysis.src} alt="" className=" h-32 w-AUTO ml-[3.5rem] mt-2" />
            <p className="text-black font-almarai mt-3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque congue massa justo, ut cursus leo fringilla tempus. Sed tempus bibendum...
            </p>
      </div>
      <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-8 rounded-xl shadow-lg w-full max-w-4xl mx-auto mt-[4rem] border-2 border-purple-400">
        ...
        <img src={skilltest.src} alt="" className=" h-32 w-AUTO ml-[3.5rem] mt-2" />
            <p className="text-black font-almarai mt-3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque congue massa justo, ut cursus leo fringilla tempus. Sed tempus bibendum...
            </p>
      </div>
      <div className="relative bg-gradient-to-r bg-gradient from-blue-100 via-white to-blue-100 p-8 rounded-xl shadow-lg  max-w-3xl mx-auto mt-[4rem] border-2 border-purple-400">
        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2">
          <div className="flex w-[10.2rem] bg-white border-b-2 border-b-purple-400 border-r-2 border-r-purple-400 border-l-2 border-l-purple-400 px-4 py-4 rounded-b-lg mt-[1.9rem]">
            <div className="flex items-center w-[9rem] bg-white px-4 py-2 rounded-t-lg rounded-b-lg mb-[-0.5rem] mr-[-0.5rem] ml-[-0.5rem] border-2 border-black mt-[-3.2rem]">
        ...
        <img src={problemsolving.src} alt="" className=" h-32 w-AUTO ml-[3.5rem] mt-2" />
            <p className="text-black font-almarai mt-3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque congue massa justo, ut cursus leo fringilla tempus. Sed tempus bibendum...
            </p>
      </div>

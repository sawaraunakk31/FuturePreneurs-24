...
function NavBar() {
    ...
    return (
    <nav className="fixed top-0 right-0 z-10 w-full bg-transparent shadow-md">
        <div className="flex items-center justify-between px-4 py-3 mx-auto lg:w-full md:items-center md:flex md:px-8">
        {/* LOGO */}
